...
# 用户手动激活后，距离下次登录保留时间（分钟）
ACTIVATION_NEXT_LOGIN_RETENTION_TTL = CONFIG.ACTIVATION_NEXT_LOGIN_RETENTION_TTL  # Unit: minute
# 不是活动用户的定时任务扫描 crom
CRONTAB_INACTIVE_USERS_TIME = CONFIG.CRONTAB_INACTIVE_USERS_TIME  # Unit: minute
